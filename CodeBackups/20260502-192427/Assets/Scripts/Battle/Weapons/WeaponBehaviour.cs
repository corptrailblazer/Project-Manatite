...
public class WeaponBehaviour : MonoBehaviour, IEquippable
{
    ...
    private Vector2 fppos;           // cached firepoint world pos
    private Vector2 fpright;         // cached firepoint right
    ...
    private void TickFiring()
    {
        ...
        var target = HasEnemyInArc(fppos, fpright);
    ...
    private Transform HasEnemyInArc(Vector2 origin, Vector2 forward)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            fp.localRotation = Quaternion.Euler(0f, 0f, 90f);
            return h.transform;
        }
